...
q+" | ")}).join("\n"):q+d+'"'+a.text+'"'+m},normalize:function(a){a||(a=this.tree);if(!a)return"";var d=a.not?"NOT ":"",j=[],g=this;return a.bool?(a.subs.forEach(function(a){j.push(g.normalize(a))}),d||a!=this.tree?d+"("+j.join(" "+a.bool+" ")+")":j.join(" "+a.bool+" ")):/^(and|or|not)$/i.test(a.text)||/[\s\(\)\+\-\!\?\|]/.test(a.text)?d+'"'+a.text+'"':d+a.text},match:function(a){if(!this.tree)return!1;var d=this,j=function(a){delete a.match;a.bool&&a.subs.forEach(function(a){j(a)})},g=function(a,
k,f){var e,c,l,j;if(a.bool)if("AND"==a.bool){e=!0;for(c=0;c<a.subs.length&&e;++c)e=g(a.subs[c],k,f)}else{e=!1;for(c=0;c<a.subs.length&&(!(e=g(a.subs[c],k,f)||e)||f);++c);}else if(!1!==f&&!a.not)for(e=!1;null!=(c=a.rex.exec(k));)e=!0,l=c[0],c=c.index,d.opts.sensitive||(l=l.toLowerCase()),d.opts.wholeword&&(j=l.length,l=l.replace(/^\W+|\W+$/g,""),c+=j-l.length),void 0==f[l]&&(f[l]=[]),f[l].push(c);else e=a.rex.test(k);a.not&&(e=!e);return a.match=e},m=this.opts.matches?{}:!1;j(this.tree);a=g(this.tree,
this.opts.unaccent?r(a):a,m);this.opts.debug&&(console.log(this.dump()),m&&console.log(m));return this.opts.matches&&a?m:a}};d&&("string"==typeof d?j.parse(d):"object"==typeof d&&(["debug","sensitive","wholeword","unaccent","matches"].forEach(function(a){void 0!==d[a]&&(j.opts[a]=d[a])}),d.query&&j.parse(d.query)));return j};